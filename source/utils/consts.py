...
DB_PATH = os.path.join(os.path.dirname(os.path.abspath(os.path.join(__file__, '..'))), r'database\db\real_estate.db')

#key
KEY = 'BE0pe3FZvGzjcoPpBsERaENzd6clg+6PIWYNrQRsUrC9YVTlDep6NqMhhBmohZSu'
